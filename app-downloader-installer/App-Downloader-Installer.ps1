...
# Run based on mode
switch ($Mode) {
    "download-only"     { Download-Files -Config $ConfigData }
    "install-only"      { Install-Files -Config $ConfigData }
    "download-install"  { Download-Files -Config $ConfigData; Install-Files -Config $ConfigData }
