...
- **Background-Scheduler**: Dynamically manage desktop wallpapers using a theme library and daily scheduling.
...
- **Wake-On-Lan**: Starts physical machines using Wake On LAN magic packets.
